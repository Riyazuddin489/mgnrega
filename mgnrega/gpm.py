...
class GPM:
    ...
    def assign_members_to_projects(self):
        ...
        members_list = {key: value for key, value in members_list.items() if project_members_id.count(value) == 0}
        menu = Menu()
    ...
    def assign_project_members_request(self):
        ...
        try:
            ...
            for old_request in old_requests:
                ...
                if old_request_data[0] == str(ApprovalType.MEMBER.name) and old_request_data[2] ==self.member_id and old_request_data[2]:
